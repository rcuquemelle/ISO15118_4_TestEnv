...
namespace Pixit_15118_2 {
  namespace PIXIT_15118_2 {
    namespace PIXIT_CMN {
      ...
      iso1Part4_PhysicalValueType par_EVTargetVoltage = {.multiplier=0, .unit=iso1Part4_UnitSymbolType::v,.value_=500};
      iso1Part4_PhysicalValueType par_EVTargetCurrent = {.multiplier=0, .unit=iso1Part4_UnitSymbolType::a,.value_=55};
      iso1Part4_PhysicalValueType par_EVBatteryVoltage = {.multiplier=0, .unit=iso1Part4_UnitSymbolType::v,.value_=400};
      iso1Part4_PhysicalValueType par_EVMaximumVoltageLimit = {.multiplier=0, .unit=iso1Part4_UnitSymbolType::v,.value_=700};
