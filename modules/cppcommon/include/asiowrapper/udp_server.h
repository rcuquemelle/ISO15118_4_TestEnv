...
public:
    ...
    */
    UDPServer(const std::shared_ptr<Service>& service, int port, InternetProtocol protocol = InternetProtocol::IPv6);
    ...
    */
    ...
    // void set_endpoint(const std::string& address, int port) {_endpoint = asio::ip::udp::endpoint(asio::ip::udp::v6(), (unsigned short)port);}
