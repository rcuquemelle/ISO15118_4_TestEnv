#include "V2GAppSECCChargingStatus.h"
...
TestCases_SECC_ChargingStatus::TestCases_SECC_ChargingStatus(std::shared_ptr<SECC_Tester>& _mtc, std::shared_ptr<System_SECC> _stc,\
...
{
  this->tb = std::make_shared<TestBehavior_SECC_ChargingStatus>(this->mtc, this->stc);
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_001"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_001));
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_002"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_002));
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_003"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_003));
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_004"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_004));
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_005"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_005));
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_006"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_006));
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_007"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_007));
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_008"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_008));
  this->testcase_map.emplace(std::make_pair(std::string("TC_SECC_AC_VTB_ChargingStatus_009"), &TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_009));
}

TestCases_SECC_ChargingStatus::~TestCases_SECC_ChargingStatus()
{
}


/**
1. CONDITION: Test System executes GoodCase procedure and sends a ChargingStatusReq message
with the current SessionID and all additional mandatory parameters.
2. EXPECTED: Test System then checks that the SUT sends a ChargingStatusRes message with the
...
*/
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_001()
{
  ...
  {
    this->tb->f_SECC_AC_TB_VTB_ChargingStatus_001(fail);
  }
  else
  {
...
*/
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_002()
{
  Logging::info(LogTc_ENABLE, fmt::format("----- TEST CASE {} START -----",__FUNCTION__));
  std::shared_ptr<HAL_61851_Listener> v_HAL_61851_Listener;
  verdict_val preConVerdict;
...
message instead of a ChargingStatusReq message.
...
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_003()
{
  ...
  if (preConVerdict == pass)
  {
    this->tb->f_SECC_AC_TB_VTB_ChargingStatus_002();
  }
  else
  {
    Logging::info(LogTc_ENABLE, "PreCondition was unsuccessful.");
...
2. EXPECTED: Test System then checks that the SUT sends a ChargingStatusRes message with a
...
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_004()
{
  ...
  if (preConVerdict == pass)
  {
    this->tb->f_SECC_AC_TB_VTB_ChargingStatus_003();
  }
  else
  {
    Logging::info(LogTc_ENABLE, "PreCondition was unsuccessful.");
...
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_005()
{
  ...
  if (preConVerdict == pass)
  {
    this->tb->f_SECC_AC_TB_VTB_ChargingStatus_004();
  }
  else
  {
    Logging::info(LogTc_ENABLE, "PreCondition was unsuccessful.");
...
3. PICS selection: PICS_CMN_CMN_ChargingMode = aC
4. PIXIT selection: PIXIT_SECC_CMN_ReceiptRequired = false, PIXIT_SECC_CMN_MeterInfo = meterInfo,
PIXIT_CMN_CMN_MeterReading = unknown
*/
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_006()
{
  Logging::info(LogTc_ENABLE, fmt::format("----- TEST CASE {} START -----",__FUNCTION__));
  std::shared_ptr<HAL_61851_Listener> v_HAL_61851_Listener;
  verdict_val preConVerdict;
  ...
  if (preConVerdict == pass)
  {
    this->tb->f_SECC_AC_TB_VTB_ChargingStatus_005();
  }
  else
  {
    Logging::info(LogTc_ENABLE, "PreCondition was unsuccessful.");
...
*/
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_007()
{
  Logging::info(LogTc_ENABLE, fmt::format("----- TEST CASE {} START -----",__FUNCTION__));
  std::shared_ptr<HAL_61851_Listener> v_HAL_61851_Listener;
  verdict_val preConVerdict;
...
*/
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_008()
{
  Logging::info(LogTc_ENABLE, fmt::format("----- TEST CASE {} START -----",__FUNCTION__));
  std::shared_ptr<HAL_61851_Listener> v_HAL_61851_Listener;
  verdict_val preConVerdict;
...
*/
verdict_val TestCases_SECC_ChargingStatus::TC_SECC_AC_VTB_ChargingStatus_009()
{
  Logging::info(LogTc_ENABLE, fmt::format("----- TEST CASE {} START -----",__FUNCTION__));
  std::shared_ptr<HAL_61851_Listener> v_HAL_61851_Listener;
  verdict_val preConVerdict;
