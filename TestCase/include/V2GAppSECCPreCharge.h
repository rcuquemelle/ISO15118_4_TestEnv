#ifndef __V2GAPPSECCPRECHARGE_H__
#define __V2GAPPSECCPRECHARGE_H__
...
class TestCases_SECC_PreCharge: public V2GTestcaseBase
{
private:
  std::map<std::string, verdict_val(TestCases_SECC_PreCharge::*)(void)> testcase_map;
  std::shared_ptr<TestBehavior_SECC_PreCharge> tb;
public:
  TestCases_SECC_PreCharge(std::shared_ptr<SECC_Tester>& _mtc, std::shared_ptr<System_SECC> _stc,\
  ...
  ~TestCases_SECC_PreCharge();

  verdict_val TC_SECC_DC_VTB_PreCharge_001(void);
  verdict_val TC_SECC_DC_VTB_PreCharge_002(void);
  verdict_val TC_SECC_DC_VTB_PreCharge_003(void);
  verdict_val TC_SECC_DC_VTB_PreCharge_004(void);
...
#endif // __V2GAPPSECCPRECHARGE_H__